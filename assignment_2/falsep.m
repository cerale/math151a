...
fstring  = 'x^6 - x - 1';     % target function specified by
                                    % a string
 disp("f(x) = " + fstring);         % to print the function at the beginnin
                                    % of my file 
                                   
maximalIterations = 1000;           % Maximal number of iterations
a   = 1.00;                         % left starting endpoint
b   = 1.20;                         % right starting endpoint

disp ("Interval: [" + a + ", " + b + "]"); % print out the interval 
...
while(iter < maximalIterations)  
   ...
   c = ((a*(fb-fa) - (fa*(b-a)))/(fb-fa));  % midpoint =  approximate root
